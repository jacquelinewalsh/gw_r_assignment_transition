...
### FUNCTION FOR SCRAPING NOMINEES #### 
...
#Because the staff page uses the same structure, we can repurpose our 
# existing function from above to capture this page's names as well
